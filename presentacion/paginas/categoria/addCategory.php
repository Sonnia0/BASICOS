...
<body class="bg-gray-100">
    ...
    <div class="container max-w-md py-8 mx-auto">
        ...
        <div class="flex items-center justify-between mb-4 text-justify">
            <h1 class="text-3xl font-bold text-gray-800">Agregar Categoría</h1>
        </div>

        <form id="addCategoryForm" class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                <button type="submit"
                    class="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline">Agregar</button>
            </div>
        </form>
    </div>
    <script src="../../scripts/categoria/add-category.js"></script>
</body>
