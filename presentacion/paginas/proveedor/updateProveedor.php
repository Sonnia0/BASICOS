...
<body class="bg-gray-100">
    ...
    <div class="container max-w-md py-8 mx-auto">
        ...
        <form id="updateProveedorForm" class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md">
            ...
            <div class="flex items-center justify-between">
                <button type="submit"
                    class="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline">Actualizar Proveedor</button>
            </div>
        </form>
    </div>
